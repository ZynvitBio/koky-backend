...
export interface ApiAboutSectionAboutSection
  ...
  attributes: {
    ...
    icon: Schema.Attribute.Media<
      ...
      true
    >;
    iconTextHighlight: Schema.Attribute.String;
    iconTextPrefix: Schema.Attribute.String;
    iconTextSuffix: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiBatchBatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quantityReceived: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeHeroMessageHomeHeroMessage
  ...
  info: {
    displayName: 'HomeHeroMessage';
    pluralName: 'home-hero-messages';
    singularName: 'home-hero-message';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    h1_suffix: Schema.Attribute.String;
    h1HighlightedText: Schema.Attribute.String;
    h1Prefix: Schema.Attribute.String;
    linkText: Schema.Attribute.String;
    linkUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-hero-message.home-hero-message'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomeHeroSettingHomeHeroSetting
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_hero_settings';
  info: {
    displayName: 'HomeHeroSetting';
    pluralName: 'home-hero-settings';
    singularName: 'home-hero-setting';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-hero-setting.home-hero-setting'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    wompi_reference: Schema.Attribute.String;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    availableToday: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    categories: Schema.Attribute.Relation<
      ...
      'api::category.category'
    >;
    contentPerUnit: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    externalProductUrl: Schema.Attribute.String;
    ...
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    immediateDeliveryStock: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    ...
    minStockAlert: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    oldPrice: Schema.Attribute.Decimal;
    price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    priorityOrder: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    relatedFromProducts: Schema.Attribute.Relation<
      'manyToMany',
      'api::product.product'
    >;
    ...
    stock: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    supplierBatchSize: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    unitAbbreviation: Schema.Attribute.Enumeration<
      ['g', 'kg', 'und', 'ml', 'L']
    >;
    unitMeasure: Schema.Attribute.Enumeration<
      ['Gramos', 'Kilogramos', 'Unidad', 'Litros', 'Mililitros']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categories: Schema.Attribute.Relation<
      ...
      'api::category.category'
    >;
    cookingTip: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ingredients: Schema.Attribute.Component<
      'recipe-elements.ingredients',
      true
    >;
    instructions: Schema.Attribute.Component<
      'recipe-elements.instruction-step',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiSameDayProductSameDayProduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'same_day_products';
  info: {
    displayName: 'sameDayProduct';
    pluralName: 'same-day-products';
    singularName: 'same-day-product';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryMessage: Schema.Attribute.String;
    linkText: Schema.Attribute.String;
    linkUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::same-day-product.same-day-product'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    is_founder: Schema.Attribute.Boolean &
    ...
    whatsapp_id: Schema.Attribute.String & Schema.Attribute.Configurable;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::same-day-product.same-day-product': ApiSameDayProductSameDayProduct;
